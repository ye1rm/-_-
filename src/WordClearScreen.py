...
def render_word_clear_screen(screen, font):
    ...
    # 게임 시작 버튼 
    pygame.draw.rect(screen, LIGHT_GREEN, (start_button_x, start_button_y+120, button_width, button_height))
    start_text = font.render("Game Start", True, TEXT_COLOR)
    start_text_rect = start_text.get_rect(center=(start_button_x + button_width // 2, start_button_y+120 + button_height // 2))
